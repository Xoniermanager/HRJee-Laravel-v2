                    ...
                    <div class="card-body">
                        <div class="row g-xl-5 g-3 gy-5">
                            <div class="col-xxl-12 col-xl-8 box-col-8 position-relative">
                                <form enctype="multipart/form-data" action="{{route('admin.menu.save')}}" method="post">
                                    @csrf
                                    ...
                                    <div class="row g-3 custom-input pb-5">
                                        ...
                                        <div class="col-12 mb-4">
                                            <div class="row gx-xl3 gx-md-2 gy-md-0 g-2">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <label class="form-label required" for="exampleFormControlInput1">Menu
                                                        Icon</label>
                                    ...
                                    <div class="product-buttons">
                                        <button type="submit"
                                            class="companyAccountBtn btn d-flex align-items-center gap-sm-2 gap-1">Submit
