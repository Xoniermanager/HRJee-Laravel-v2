<div id="department_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">Department Name</span>
                            </th>
                    ...
                    @forelse ($allDepartmentDetails as $key => $departmentDetail)
                    <tr>
                        <td>
                        ...
                        <td>
                            <p class="f-light">{{ $departmentDetail->name }}</p>
                        </td>
                        <td>
                            <div class="form-check form-switch form-check-inline">
                                <input type="checkbox" <?=$departmentDetail->status == '1' ? 'checked' : '' ?>
                                onchange="handleStatus({{ $departmentDetail->id }})" id="checked_value_{{
                                $departmentDetail->id }}" class="form-check-input switch-info check-size">
                        ...
                        <td>
                            <div class="product-action"><a href="#" data-bs-toggle="modal"
                                    ...
                                    onClick="edit_department_details('{{ $departmentDetail->id }}', '{{ $departmentDetail->name }}')">
                                ...
                                <a href="#" onclick="deleteFunction('{{ $departmentDetail->id }}')">
    ...
    <div class="mt-3">
        {{ $allDepartmentDetails->links('paginate') }}
    </div>
</div>
