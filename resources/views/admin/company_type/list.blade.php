<div id="company_type_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">Name</span>
                            </th>
                    ...
                    @forelse ($allCompanyTypeDetails as $key => $companyTypeDetail)
                    <tr>
                        <td>
                        ...
                        <td>
                            <p class="f-light">{{ $companyTypeDetail->name }}</p>
                        </td>
                        <td>
                            <div class="form-check form-switch form-check-inline">
                                <input type="checkbox" <?=$companyTypeDetail->status == '1' ? 'checked' : '' ?>
                                onchange="handleStatus({{ $companyTypeDetail->id }})" id="checked_value_{{
                                $companyTypeDetail->id }}" class="form-check-input switch-info check-size">
                        ...
                        <td>
                            <div class="product-action"><a href="#" data-bs-toggle="modal"
                                    ...
                                    onClick="edit_company_type_details('{{ $companyTypeDetail->id }}', '{{ $companyTypeDetail->name }}')">
                                ...
                                <a href="#" onclick="deleteFunction('{{ $companyTypeDetail->id }}')">
    ...
    <div class="mt-3">
        {{ $allCompanyTypeDetails->links('paginate') }}
    </div>
</div>
