<div  id="employee_status_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">status Name</span>
                            </th>
                            <th>
                                <span class="f-light f-w-600">Description</span>
                            </th>
                        ...
                        @forelse ($allEmployeeStatusDetails as $key => $employeeStatusDetails)
                            <tr>
                                ...
                                <td>
                                        <p class="f-light">{{ $employeeStatusDetails->name }}</p>
                                </td>

                                <td>
                                    <p class="f-light">{{ $employeeStatusDetails->description }}</p>
                            </td>
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            <input type="checkbox" <?= $employeeStatusDetails->status == '1' ? 'checked' : '' ?>
                                            onchange="handleStatus({{ $employeeStatusDetails->id }})" id="checked_value_{{ $employeeStatusDetails->id }}" class="form-check-input switch-info check-size">
                                ...
                                <td>
                                    <div class="product-action"><a href="#" data-bs-toggle="modal"
                                        data-bs-target="#edit_employee_status"
                                        onClick="edit_employee_status_details('{{ $employeeStatusDetails->id }}', '{{ $employeeStatusDetails->name }}','{{ $employeeStatusDetails->description }}')">
                                         ...
                                         <a href="#" onclick="deleteFunction('{{ $employeeStatusDetails->id }}')">
    ...
    <div class="mt-3">
        {{ $allEmployeeStatusDetails->links('paginate') }}
