<div  id="document_type_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">Document Name </span>
                            </th>
                            <th>
                                <span class="f-light f-w-600">Document Description</span>
                            </th>

                            <th>
                                <span class="f-light f-w-600">Is Mandatory</span>
                            </th>
                            <th>
                        ...
                        @forelse ($allDocumentTypes as $key => $allDocumentType)
                            <tr>
                                ...
                                <td>
                                        <p class="f-light">{{ $allDocumentType->name }}</p>
                                </td>

                                <td>
                                    <p class="f-light">{{ $allDocumentType->description }}</p>
                            </td>
                            <td>
                                <?php
                                $is_mandatory = '';
                               ...
                               <?php  } ?>
                                ...
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            <input type="checkbox" <?= $allDocumentType->status == '1' ? 'checked' : '' ?>
                                            onchange="handleStatus({{ $allDocumentType->id }})" id="checked_value_{{ $allDocumentType->id }}" class="form-check-input switch-info check-size">
                                ...
                                <td>
                                    <div class="product-action"><a href="#" data-bs-toggle="modal"
                                        data-bs-target="#edit_document_type"
                                        onClick="edit_document_type_details('{{ $allDocumentType->id }}', '{{ $allDocumentType->name }}', '{{ $allDocumentType->description }}','{{ $allDocumentType->is_mandatory }}')">
                ...
                @empty
                    <td colspan="3">
                        <span class="text-danger">
                            <strong>No document_type Found!</strong>
                        </span>
                    </td>
                    @endforelse
                </table>
