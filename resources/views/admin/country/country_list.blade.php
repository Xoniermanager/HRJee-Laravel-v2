<div id="country_list" class="card-body">
        ...
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
            ...
            <div class="datatable-container">
                <table class="table nowrap" id="project-status">
                    ...
                    @forelse ($allCountryDetails as $key => $countryDetail)
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class="form-check form-switch form-check-inline">
                                ...
                                $countryDetail->id }}" class="form-check-input switch-info check-size">
                        ...
                        <td>
                            <div class="product-action"><a href="#" data-bs-toggle="modal"
                                ...
                                <a href="#" onclick="deleteFunction('{{ $countryDetail->id }}')">
    ...
    <div class="mt-3">
        {{ $allCountryDetails->links('paginate') }}
    </div>
</div>
