<div  id="previous_company_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">previous company Name</span>
                            </th>
                        ...
                        @forelse ($allPreviousCompanyDetails as $key => $allPreviousCompanyDetail)
                            <tr>
                                <td>
                                ...
                                <td>
                                        <p class="f-light">{{ $allPreviousCompanyDetail->name }}</p>
                                </td>
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            <input type="checkbox" <?= $allPreviousCompanyDetail->status == '1' ? 'checked' : '' ?>
                                            onchange="handleStatus({{ $allPreviousCompanyDetail->id }})" id="checked_value_{{ $allPreviousCompanyDetail->id }}" class="form-check-input switch-info check-size">
                                ...
                                <td>
                                    <div class="product-action"><a href="#" data-bs-toggle="modal"
                                        data-bs-target="#edit_previous_company"
                                        onClick="edit_previous_company_details('{{ $allPreviousCompanyDetail->id }}', '{{ $allPreviousCompanyDetail->name }}')">
                                         ...
                                         <a href="#" onclick="deleteFunction('{{ $allPreviousCompanyDetail->id }}')">
                ...
                @empty
                    <td colspan="3">
                        <span class="text-danger">
                            <strong>No previous company Found!</strong>
                        </span>
                    </td>
                    @endforelse
                </table>
    ...
    <div class="mt-3">
        {{ $allPreviousCompanyDetails->links('paginate') }}
    </div>
</div>
