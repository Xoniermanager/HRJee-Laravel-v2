                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">State</span>
                            </th>
                            <th>
                                <span class="f-light f-w-600">Country</span>
                            </th>
                    ...
                    @forelse ($allStateDetails as $key => $stateDetail)
                    <tr>
                        <td>
                        ...
                        <td>
                            <p class="f-light">{{ $stateDetail->name }}</p>
                        </td>
                        <td>
                            <p class="f-light">{{ $stateDetail->countries->name }}</p>
                        </td>
                        <td>
                            <div class="form-check form-switch form-check-inline">
                                <input type="checkbox" <?=$stateDetail->status == '1' ? 'checked' : '' ?>
                                onchange="handleStatus({{ $stateDetail->id }})" id="checked_value_{{ $stateDetail->id
                        ...
                        <td>
                            <div class="product-action"><a href="#" data-bs-toggle="modal" data-bs-target="#edit_state"
                                ...
                                <a href="#" onclick="deleteFunction('{{ $stateDetail->id }}')">
