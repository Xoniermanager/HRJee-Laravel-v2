<div  id="qualification_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">Qualification Name</span>
                            </th>
                        ...
                        @forelse ($allQualificationDetails as $key => $qualificationDetail)
                            <tr>
                                <td>
                                ...
                                <td>
                                        <p class="f-light">{{ $qualificationDetail->name }}</p>
                                </td>
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            <input type="checkbox" <?= $qualificationDetail->status == '1' ? 'checked' : '' ?>
                                            onchange="handleStatus({{ $qualificationDetail->id }})" id="checked_value_{{ $qualificationDetail->id }}" class="form-check-input switch-info check-size">
                                ...
                                <td>
                                    <div class="product-action"><a href="#" data-bs-toggle="modal"
                                        data-bs-target="#edit_qualification"
                                        onClick="edit_qualification_details('{{ $qualificationDetail->id }}', '{{ $qualificationDetail->name }}')">
                                         ...
                                         <a href="#" onclick="deleteFunction('{{ $qualificationDetail->id }}')">
    ...
    <div class="mt-3">
        {{ $allQualificationDetails->links('paginate') }}
    </div>
</div>
