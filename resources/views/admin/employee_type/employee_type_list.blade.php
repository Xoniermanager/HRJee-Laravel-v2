<div  id="employee_type_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">Employee Type</span>
                            </th>
                            <th>
                        ...
                        @forelse ($allEmployeeTypeDetails as $key => $employeeTypeDetails)
                            <tr>
                                ...
                                <td>
                                        <p class="f-light">{{ $employeeTypeDetails->name }}</p>
                                </td>

                                <td>
                                    <p class="f-light">{{ $employeeTypeDetails->description }}</p>
                            </td>
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            <input type="checkbox" <?= $employeeTypeDetails->status == '1' ? 'checked' : '' ?>
                                            onchange="handleStatus({{ $employeeTypeDetails->id }})" id="checked_value_{{ $employeeTypeDetails->id }}" class="form-check-input switch-info check-size">
                                ...
                                <td>
                                    <div class="product-action"><a href="#" data-bs-toggle="modal"
                                        ...
                                        onClick="edit_employee_type_details('{{ $employeeTypeDetails->id }}', '{{ $employeeTypeDetails->name }}','{{ $employeeTypeDetails->description }}')">
                                         ...
                                         <a href="#" onclick="deleteFunction('{{ $employeeTypeDetails->id }}')">
    ...
    <div class="mt-3">
        {{ $allEmployeeTypeDetails->links('paginate') }}
