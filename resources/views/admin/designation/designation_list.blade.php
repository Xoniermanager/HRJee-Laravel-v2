<div  id="designation_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">Designation Name</span>
                            </th>
                            <th>
                    ...
                    <tbody>
                        @forelse ($allDesignationDetails as $key => $designationDetail)
                            <tr>
                                ...
                                <td>
                                        <p class="f-light">{{ $designationDetail->name }}</p>
                                </td>

                                <td>
                                        <p class="f-light">{{ $designationDetail->departments->name }}</p>
                                </td>
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            <input type="checkbox" <?= $designationDetail->status == '1' ? 'checked' : '' ?>
                                            onchange="handleStatus({{ $designationDetail->id }})" id="checked_value_{{ $designationDetail->id }}" class="form-check-input switch-info check-size">
                                ...
                                <td>
                                    <div class="product-action"><a href="#" data-bs-toggle="modal"
                                        ...
                                        onClick="edit_designation_details('{{ $designationDetail->id }}', '{{ $designationDetail->name }}','{{ $designationDetail->department_id }}')">
                                         ...
                                         <a href="#" onclick="deleteFunction('{{ $designationDetail->id }}')">
