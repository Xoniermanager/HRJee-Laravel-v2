        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header file-content border-0 pb-0">
                        <div class="d-md-flex d-sm-block">
                            ...
                            <div class="ml-10px" style="margin-left: 10px;">
                                <select class="form-select h-50px" name="filter_department"
                    ...
                    @include('admin.designation.designation_list')
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-toggle-wrapper">
                    ...
                    <form class="row g-3" id="designation_update_form">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" placeholder="Enter Your designation Name"
                                name="name" id="name">
                            @error('name')
                    ...
                    <form class="row g-3" id="designation_form">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" type="text" name="name"
                                placeholder="Enter Your designation Name" id="name">
                            @error('name')
                            <span class="text-denger">{{ $message}} </span>
                            @enderror
                        </div>
...
<script>
        ...
        jQuery("#filter_department").on('change', function() {
            ...
            function search_designation_filter()
            {
                $.ajax({
                        url: "{{ route('admin.designation.search') }}",
                        type: 'get',
                        data: {
        ...
        function handleStatus(id) {
            ...
            $.ajax({
                url: "{{ route('admin.designation.statusUpdate') }}",
                type: 'get',
                data: {
                    'id': id,
                    'status': status,
