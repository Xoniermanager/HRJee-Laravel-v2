<div  id="company_size_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f$allCompanySizeDetail-w-600">Company Size</span>
                            </th>
                        ...
                        @forelse ($allCompanySizesDetails as $key => $companySizeDetails)
                            <tr>
                                ...
                                <td>
                                        <p class="f-light">{{ $companySizeDetails->company_size }}</p>
                                </td>

                                <td>
                                    <p class="f-light">{{ $companySizeDetails->description }}</p>
                            </td>
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            <input type="checkbox" <?= $companySizeDetails->status == '1' ? 'checked' : '' ?>
                                            onchange="handleStatus({{ $companySizeDetails->id }})" id="checked_value_{{ $companySizeDetails->id }}" class="form-check-input switch-info check-size">
                                ...
                                <td>
                                    <div class="product-action"><a href="#" data-bs-toggle="modal"
                                        ...
                                        onClick="edit_company_size_details('{{ $companySizeDetails->id }}', '{{ $companySizeDetails->company_size }}','{{ $companySizeDetails->description  }}')">
