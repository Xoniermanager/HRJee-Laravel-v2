<div id="subscription_plan_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">Title</span>
                            </th>
                            <th>
                    ...
                    @forelse ($allSubscriptionPlanDetails as $key => $subscriptionPlanDetail)
                        <tr>
                            <td>
                            ...
                            <td>
                                <p class="f-light">{{ $subscriptionPlanDetail->title }}</p>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="form-check form-switch form-check-inline">
                                    <input type="checkbox"
                                        ...
                                        onchange="handleStatus({{ $subscriptionPlanDetail->id }})"
                                        id="checked_value_{{ $subscriptionPlanDetail->id }}"
                            ...
                            <td>
                                <div class="product-action"><a href="#" data-bs-toggle="modal"
                                    ...
                                    <a href="#" onclick="deleteFunction('{{ $subscriptionPlanDetail->id }}')">
    ...
    <div class="mt-3">
        {{ $allSubscriptionPlanDetails->links('paginate') }}
    </div>
</div>
