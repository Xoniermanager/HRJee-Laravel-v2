                            ...
                            <div class="row g-xl-5 g-3 gy-5">
                                <div class="col-xxl-3 col-xl-4 box-col-4e sidebar-left-wrapper">
                                    <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation"> <a class="nav-link disable"
                                ...
                                <div class="col-xxl-9 col-xl-8 box-col-8 position-relative">
                                    <div class="tab-content" id="add-product-pills-tabContent">
                                        <div class="tab-pane fade active show" id="detail-product" role="tabpanel"
                                            ...
                                            <div class="meta-body">
                                                <form id="companyAccountform" enctype="multipart/form-data">
                                                    @csrf
        ...
        $(document).ready(function () {
            ...
            $('.companyDetailbtn').click(function (e) {
                ...
                if ($("#companyDetailForm").valid()) {
                    ...
                    $.ajax({
                        url: "<?= route('admin.company.store') ?>", // Ensure this route is correct
                        type: 'POST',
                        data: formData,
