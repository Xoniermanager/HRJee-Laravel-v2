							...
							<div class="row g-xl-5 g-3 gy-5">
								<div class="col-xxl-3 col-xl-4 box-col-4e sidebar-left-wrapper">
									<ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
										<li class="nav-item" role="presentation"> <a class="nav-link active" id="detail-product-tab"
												data-bs-toggle="pill" href="#detail-product" role="tab" aria-controls="detail-product"
										...
										<li class="nav-item" role="presentation"> <a class="nav-link" id="category-product-tab" data-bs-toggle="pill"
													...
													<div class="row g-3 custom-input pb-5">
														<div class="col-12">
															<div class="row gx-xl-3 gx-md-2 gy-md-0 g-2">
																<div class="col-12">
																	<label class="form-label" for="exampleFormControlInput1">Company
																		Detail</label>
																</div>
																...
																<div class="col-md-6 col-sm-6">
																	<input class="form-control" id="contact_no" name="contact_no" type="number"
																		placeholder="Contact No." value="{{ $companyDetails->companyDetails->contact_no }}">
																</div>
															...
															<div class="row gx-xl-3 gx-md-2 gy-md-0 g-2">
																...
																<div class="col-md-6 col-sm-6">
																	<input class="form-control" id="username" name="username"
																		value="{{ $companyDetails->companyDetails->username }}" type="text" placeholder="UsernName">
																</div>
																<div class="col-md-6 col-sm-6">
														...
														<div class="col-md-6 col-sm-6">
															<select class="form-control" id="face_recognition" name="allow_face_recognition"
																onchange="toggleUserLimit()">
																<option value="" disabled>Allow Face Recognition
																</option>
																<option value="0">No</option>
																<option value="1"
																	{{ $companyDetails->companyDetails->allow_face_recognition == 1 ? 'selected' : '' }}>
																	Yes</option>
															</select>
														</div>

														<!-- User Limit (Hidden by Default) -->
														<div class="col-md-6 col-sm-6" id="face_recognition_user_limit_container"
															style="display: {{ $companyDetails->companyDetails->allow_face_recognition == 1 ? 'block' : 'none' }};">
															<input class="form-control" id="face_recognition_user_limit" name="face_recognition_user_limit"
																type="number" placeholder="Enter User Limit for Face Recgnition"
																value="{{ $companyDetails->companyDetails->face_recognition_user_limit }}">
														</div>
														<!-- Face Nex Dropdown -->
														<div class="col-md-6 col-sm-6">
															<select class="form-control" id="allow_face_nex" name="allow_face_nex">
																<option value="" disabled>Allow Face Nex
																</option>
																<option value="0" {{ $companyDetails->companyDetails->allow_face_nex == 0 ? 'selected' : '' }}>No
																</option>
																<option value="1" {{ $companyDetails->companyDetails->allow_face_nex == 1 ? 'selected' : '' }}>
																	Yes</option>
															</select>
														</div>
														@if (checkMenuAccessByMenuAndCompany('location-tracking', $companyDetails->id))
															<div class="col-md-6 col-sm-6" id="location_tracking_user_limit_container">
																<input class="form-control" id="location_tracking_user_limit" name="location_tracking_user_limit"
																	type="number" placeholder="Enter User Limit for Location Tracking"
													...
													<div class="row g-3 custom-input">
														<div class="col-12">
															<div class="row gx-xl-3 gx-md-2 gy-md-0 g-2">
																...
																<div class="col-md-6">
																	<input class="form-control" id="company_url" name="company_url"
																		value="{{ $companyDetails->companyDetails->company_url }}" type="url"
																		placeholder="Company Website">
																</div>
																{{-- <div class="col-md-6 col-sm-6">
																	<input class="form-control" name="industry" value="{{ $companyDetails->companyDetails->companyType->name }}"
																		type="text">
																</div> --}}
                                                                <div class="col-md-6 col-sm-6">
                                                                    <select class="form-select" id="company_type_id"
                                                                        ...
                                                                        @forelse ($allCompanyTypeDetails as $item)
                                                                            <option value="{{ $item->id }}" {{$companyDetails->companyDetails->companyType->id == $item->id ? "selected" : ""}}>
                                                                                {{ $item->name }}
                                                                            </option>
                                                                        @empty
															...
															<select class="form-select" id="subscription_id" name="subscription_id">
																...
																@forelse ($subscriptionPlans as $item)
																	<option value="{{ $item->id }}"
																		{{ $item->id == $companyDetails->companyDetails->subscription_id ? 'selected' : '' }}>
																		{{ $item->title }}
																	</option>
																@empty
														...
														<div class="col-md-6 col-sm-6">
															<input class="form-control" name="onboarding_date"
																value="{{ $companyDetails->companyDetails->onboarding_date }}" type="date">
														</div>
														<div class="col-md-6 col-sm-6">
															<div class="row">
																<div class="col-md-12 col-sm-12">
																	<input class="form-control" id="company_size" name="company_size" type="number"
															...
															<div class="row">
																<div class="col-md-12 col-sm-12">
																	<textarea class="form-control" id="company_address" name="company_address" rows="2"
																	 placeholder="Enter Your Company Address">{{ $companyDetails->companyDetails->company_address }}</textarea>
																</div>
															</div>
														</div>
					...
					$.ajax({
						...
						error: function(error_messages) {
							...
							for (var error_key in errors) {
								...
								if (error_key == 'email' || error_key == 'name' || error_key ==
									'password' || error_key == 'username' || error_key ==
									'contact_no' || error_key == 'logo') {
									$('#add-product-pills-tab a[href="#detail-product"]').tab(
										'show');
								} else {
									$('#add-product-pills-tab a[href="#category-product"]').tab(
										'show');
								}
