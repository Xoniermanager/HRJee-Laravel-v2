                                            ...
                                            <div class="meta-body">
                                                <form id="companyAccountform">
                                                    ...
                                                    <div class="row g-3 custom-input pb-5">
                                                            ...
                                                            <div class="row gx-xl-3 gx-md-2 gy-md-0 g-2">
                                                                ...
                                                                <div class="col-md-6 col-sm-6">
                                                                    <input class="form-control" id="contact_no"
                                                                        ...
                                                                        value="{{ $companyDetails->companyDetails->contact_no }}">
                                                                </div>
                                                            ...
                                                            <div class="row gx-xl-3 gx-md-2 gy-md-0 g-2">
                                                                ...
                                                                <div class="col-md-6 col-sm-6">
                                                                    <input class="form-control" id="username"
                                                                        name="username"
                                                                        value="{{ $companyDetails->companyDetails->username }}"
                                                        ...
                                                        <div class="col-md-6 col-sm-6"
                                                            id="face_recognition_user_limit_container"
                                                ...
                                                <form id="companyDetailForm">
                                                    ...
                                                    <div class="row g-3 custom-input">
                                                        <div class="col-12">
                                                            <div class="row gx-xl-3 gx-md-2 gy-md-0 g-2">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input class="form-control" id="company_url"
                                                                        name="company_url"
                                                                        value="{{ $companyDetails->companyDetails->company_url }}"
                                                                        type="url" placeholder="Company Website">
                                                                </div>
                                                                <div class="col-md-6 col-sm-6">
                                                                    <input class="form-control"
                                                                        value="{{ $companyDetails->companyDetails->companyType->name }}"
                                                                        type="text" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <select class="form-select" id="subscription_id"
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <input class="form-control" name="onboarding_date"
                                                                value="{{ $companyDetails->companyDetails->onboarding_date }}"
                                                                type="date">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="row">
                                                                <div class="col-md-12 col-sm-12">
                                                                    <input class="form-control" id="company_size"
                                                                        ...
                                                                        value="{{ $companyDetails->companyDetails->company_size }}">
                                                                </div>
                                                    ...
                                                    <div class="product-buttons">
                                                        ...
                                                        <a class="companyDetailbtn btn btn-primary" href="#">
                                                            <div
                                                                class="d-flex align-items-center gap-sm-2 gap-1 text-white">
                                                                Submit
                                                                <svg viewBox="0 0 24 24" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
