<div  id="languages_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">languages Name</span>
                            </th>
                            <th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            ...
                                            onchange="handleStatus({{ $languagesDetails->id }})" id="checked_value_{{ $languagesDetails->id }}" class="form-check-input switch-info check-size">
                                ...
                                <td>
                                    <div class="product-action"><a href="#" data-bs-toggle="modal"
                                        data-bs-target="#edit_languages"
                                        onClick="edit_languages_details('{{ $languagesDetails->id }}', '{{ $languagesDetails->name }}')">
