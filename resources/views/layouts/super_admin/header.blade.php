<div class="page-header row">
    <div class="header-logo-wrapper col-auto">
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                    src="{{ asset('super_admin/assets/images/logo-light.png')}}" alt="" /><img class="img-fluid for-dark"
                    src="{{ asset('super_admin/assets/images/logo-light.png')}}" alt="" /></a></div>
    </div>
        ...
        <div class="row">
            ...
            <div class="header-logo-wrapper col-auto p-0">
                <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                            src="../{{ asset('super_admin/assets/images/logo/logo.png')}}" alt=""></a></div>
            ...
            <div class="nav-right col-xxl-8 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
                <ul class="nav-menus">
                    <li> <span class="header-search">
                            <svg>
                                <use href="../{{ asset('super_admin/assets/svg/icon-sprite.svg#search')}}"></use>
                            </svg></span></li>
                    <li>
                        <div class="form-group w-100">
                            <div class="Typeahead Typeahead--twitterUsers">
                    ...
                    <li class="fullscreen-body"> 
                        <span>
                            <svg id="maximize-screen">
                                <use href="{{ asset('super_admin/assets/images/svg/')}}"></use>
                              </svg>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="toast-body d-flex p-0">
                                            <div class="flex-shrink-0 bg-light-primary"><img class="w-auto"
                                                    src="../{{ asset('super_admin/assets/images/dashboard/icon/wallet.png')}}"
                                                    alt="Wallet"></div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="toast-body d-flex p-0">
                                            <div class="flex-shrink-0 bg-light-info"><img class="w-auto"
                                                    src="../{{ asset('super_admin/assets/images/dashboard/icon/shield-dne.png')}}"
                                                    alt="Shield-dne"></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="toast-body d-flex p-0">
                                            <div class="flex-shrink-0 bg-light-warning"><img class="w-auto"
                                                    src="../{{ asset('super_admin/assets/images/dashboard/icon/graph.png')}}" alt="Graph">
                                            </div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="toast-body d-flex p-0">
                                            <div class="flex-shrink-0 bg-light-tertiary"><img class="w-auto"
                                                    src="../{{ asset('super_admin/assets/images/dashboard/icon/ticket-star.png')}}"
                                                    alt="Ticket-star"></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <ul class="messages">
                                <li class="d-flex b-light1-primary gap-2">
                                    <div class="flex-shrink-0"><img
                                            src="../{{ asset('super_admin/assets/images/dashboard-2/user/1.png')}}" alt="Graph"></div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                ...
                                <li class="d-flex b-light1-secondary gap-2">
                                    <div class="flex-shrink-0"><img
                                            src="../{{ asset('super_admin/assets/images/dashboard-2/user/2.png')}}" alt="Graph"></div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                ...
                                <li class="d-flex b-light1-success gap-2">
                                    <div class="flex-shrink-0"><img
                                            src="../{{ asset('super_admin/assets/images/dashboard-2/user/3.png')}}" alt="Graph"></div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                    ...
                    <li class="profile-nav onhover-dropdown px-0 py-0">
                        <div class="d-flex profile-media align-items-center"><img class="img-30 rounded-circle"
                                src="{{ asset('super_admin/assets/images/avatar.png')}}" alt="">
