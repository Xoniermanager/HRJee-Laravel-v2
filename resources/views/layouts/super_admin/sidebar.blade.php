<div class="sidebar-wrapper" data-layout="stroke-svg">
    <div>
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                    src="{{ asset('super_admin/assets/images/logo-light.png') }}" alt="logo" width="120px"></a>
            ...
            <div class="toggle-sidebar">
                ...
                <svg class="fill-icon sidebar-toggle status_toggle middle">
                    <use href="{{ asset('super_admin/assets/svg/icon-sprite.svg#fill-toggle-icon') }}"></use>
                </svg>
            </div>
        </div>
        <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid"
                    src="{{ asset('super_admin/assets/images/logo-icon.png') }}" alt="" width="30px"></a>
        </div>
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn"><a href="index.html"><img class="img-fluid"
                                src="../{{ asset('super_admin/assets/images/logo/logo-icon.png') }}" alt=""></a>
