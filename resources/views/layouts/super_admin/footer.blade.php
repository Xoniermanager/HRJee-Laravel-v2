...
<!-- latest jquery-->
<script src="{{ asset('super_admin/assets/js/jquery.min.js')}}"></script>
<!-- Bootstrap js-->
...
<script src="{{ asset('super_admin/assets/js/chart/apex-chart/stock-prices.js')}}"></script>
<script src="{{ asset('super_admin/assets/js/chart/apex-chart/moment.min.js')}}"></script>
...
<script src="{{ asset('super_admin/assets/js/datepicker/date-picker/datepicker.en.js')}}"></script>
<script src="{{ asset('super_admin/assets/js/datepicker/date-picker/datepicker.custom.js')}}"></script>
<script src="{{ asset('super_admin/assets/js/rating/jquery.barrating.js')}}"></script>
<script src="{{ asset('super_admin/assets/js/rating/rating-script.js')}}"></script>
<script src="{{ asset('super_admin/assets/js/owlcarousel/owl.carousel.js')}}"></script>
<script src="{{ asset('super_admin/assets/js/vector-map/map-vector.js')}}"></script>
<script src="{{ asset('super_admin/assets/js/countdown.js')}}"></script>
...
<script src="{{ asset('super_admin/assets/js/script1.js')}}"></script>
