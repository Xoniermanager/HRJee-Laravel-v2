      ...
      <div class="container">
        <div class="row ">
          ...
          <div class="text-center">
            <a href="index.html">
              <img class="logo-default" src="assets/images/logo/logo.png" alt="logo" width="150px">
            </a>
          </div>
                  ...
                  <div class="swiper-container testimonial-slider__container">
                      <div class="swiper-wrapper testimonial-slider__wrapper">
                          <div class="swiper-slide">
                              <div class="sign_img">
                                <img class="logo-default" src="assets/images/features/screen.png" alt="logo"> 
                              </div>
                              <div class="author-info mt-3">
                                <h6 class="name">India's quickest Payroll management with<br> unlimited salary payout &amp; payslip generation for employees.</h6>
                                
                            </div>
                          </div>
                          <div class="swiper-slide">
                            <div class="sign_img">
                              <img class="logo-default" src="assets/images/features/dashboard.png" alt="logo"> 
                            </div>
                            <div class="author-infom mt-3">
                              <h6 class="name">Boost productivity &amp; Performance with<br> our unmatched HRJee features</h6>
                              
                          </div>
                        </div>
                        <div class="swiper-slide">
                          <div class="sign_img">
                            <img class="logo-default" src="assets/images/features/4.png" alt="logo"> 
                          </div>
                          <div class="author-info mt-3">
                            <h6 class="name"><p>India's quickest Payroll management with<br> unlimited salary payout &amp; payslip generation for employees.</p></h6>
              ...
              <div class="row">
                <div class="col-lg-12 ">
                  <div class="main-form-wrapper mt-5">
                    <form class="form" action="{{ route('company_login') }}" method="POST">
                      ...
                      <div class="form-content ms-4 me-3" data-form-tab>
                       <div class="row">
                        ...
                        <div class="col-lg-7">
                          <p class="account">Don't have an account? <a href="{{ route('signup') }}" class="text-color-secondary">Sign Up</a></p>
                        </div>
                       </div>
                       <div class="form-item" data-form-item>
                        <div class="floating-label-group">
                            <input type="email" id="email" name="email" class="form-input" data-form-input required />
                    ...
                    <div class="form-item" data-form-item>
                        <div class="floating-label-group">
                            <input type="password" id="password" name="password" class="form-input" data-form-input required />
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <p><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"> Remember me</p>
                          </div>
                          <div class="col-lg-6 text-end">
                            <p> <a href="forgot_password.html" class="text-color-secondary ">Forgot Password?</a></p>
                          </div>
                         </div>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="login_footer  text-center">
                            ...
                            <span class="copyright-text mt-3">© 2024 HRJEE by <a href="https://xoniertechnologies.com/" class="text-color-secondary">Xonier Technologies </a> All Rights
                                    Reserved.</span>
