...
<div class="content d-flex flex-column flex-column-fluid fade-in-image" id="kt_content">
        ...
        <div class="row gy-5 g-xl-10">
            ...
            <div class="card card-body col-md-12">
                <div class="card-header cursor-pointer p-0">
                    ...
                    <a href="{{ route('employee.attendance.request.add') }}"
                        class="btn btn-sm btn-primary align-self-center">
                        Add Attendance Request</a>
                </div>
                @if (session('error'))
            ...
            @endif
                <div class="mb-5 mb-xl-10">
                    @include('employee.attendance_request.list')
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
    ...
    <script>
        function deleteFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?= route('employee.attendance.request.delete') ?>",
                        type: "get",
                        data: {
                            id: id
                        },
        ...
        function search_filter_results(page_no = 1) {
            $.ajax({
                type: 'GET',
                url: employee_ajax_base_url + '/attendance/request/search/filter?page=' + page_no,
                data: {
                    'status': $('#status').val(),
                },
