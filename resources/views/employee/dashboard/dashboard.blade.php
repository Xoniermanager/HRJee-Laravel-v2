					...
					<div class="mb-xl-10 mb-5">
						<div class="row g-5 g-xl-10 mb-3">
							<div class="col-xl-3 col-sm-6">
								<!--begin::Card widget 3-->
								<a href="#" class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
							...
							<div class="">
								<div class="card-body py-3">
									<div class="row">
										...
										<div class="col-md-1">
											<span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center h-40px bg-primary"
										...
										<div class="col-md-9 d-flex punchinbar" style="gap: 15px">
											...
											@if ($existingAttendanceDetail && $existingAttendanceDetail->totalBreakHour != '')
												<p>Break Time <span id="break_timer">{{ $existingAttendanceDetail->totalBreakHour }}</span>
												</p>
												<span data-kt-element="bullet" class="bullet bullet-vertical d-flex align-items-center h-40px bg-primary"
													style="width: 1px;height: 30px !important;"></span>
											@endif
			...
			<div class="modal-content modal-rounded">
				...
				<div class="modal-body scroll-y m-1">
					<form id="employee_break_history">
						@csrf
						<input type="hidden" name="employee_attendance_id" value="{{ $existingAttendanceDetail->id ?? '' }}">
