        ...
        <div class="tab-content">
            <div class="card tab-pane fade active show  mb-5 mb-xl-10" id="kt_profile_details_view" role="tabpanel">
                ...
                <div class="card-body p-9">
                    <form method="post" action="{{ route('update.basicDetails.employee') }}"
            ...
            <div class="card tab-pane fade   mb-5 mb-xl-10" id="address_tab" role="tabpanel">
                ...
                <div class="card-body p-9">
                    <!--begin::Card header-->
                    <!--begin::Card body-->
                    <form id="address_Details_form" method="POST"
                        action="{{ route('update.addressDetails.employee') }}">
                        @csrf
                        <input type="hidden" name="address_type" id="address_type"
                            value="{{ $addressTypeValue ?? '0' }}">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input class="form-control alldetails" type="text" name="l_pincode"
                                            id="l_pincode" value="{{ $local->pin_code ?? '' }}">
                                    </div>
