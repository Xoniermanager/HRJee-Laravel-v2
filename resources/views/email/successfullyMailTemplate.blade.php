                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center" valign="top" style="">
                                                                        <!-- Description Text// -->
                                                                        <p class="text"
                                                                            style="color:#666666; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left;">
                                                                            Your account security is our priority, so
                                                                            we've just completed the password change
                                                                            process. From now on, use your new password
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top">
                                                                        <!-- Description Text// -->
                                                                        <h4 class="text"
                                                                            style="line-height:1.7;color:#666; font-family:'Poppins', Helvetica, Arial, sans-serif;font-size:15px; font-weight:600; font-style:normal; letter-spacing:normal; text-align:left;padding-top:30px;">
                                                                            Thank you for keeping your account safe and
                                                                            secure!"
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top"
                                                                        ...
                                                                        <p class="text"
                                                                            ...
                                                                            For any inquiry and support please contact
                                                                            us on
                                                                            <a
                                                                                href="mailto:info@xoniertechnologies.com">
                                                                                info@xoniertechnologies.com</a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
