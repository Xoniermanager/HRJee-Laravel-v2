<div  id="company_status_list" class="card-body">
                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f$allCompanySizeDetail-w-600">Company Status</span>
                            </th>
                        ...
                        @forelse ($allCompanyStatusDetails as $key => $companyStatusDetails)
                            <tr>
                                ...
                                <td>
                                        <p class="f-light">{{ $companyStatusDetails->name }}</p>
                                </td>

                                <td>
                                    <p class="f-light">{{ $companyStatusDetails->description }}</p>
                            </td>
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            <input type="checkbox" <?= $companyStatusDetails->status == '1' ? 'checked' : '' ?>
                                            onchange="handleStatus({{ $companyStatusDetails->id }})" id="checked_value_{{ $companyStatusDetails->id }}" class="form-check-input switch-info check-size">
                                ...
                                <td>
                                    <div class="product-action"><a href="#" data-bs-toggle="modal"
                                        ...
                                        onClick="edit_company_status_details('{{ $companyStatusDetails->id }}', '{{ $companyStatusDetails->name }}','{{ $companyStatusDetails->description  }}')">
                                         ...
                                         <a href="#" onclick="deleteFunction('{{ $companyStatusDetails->id }}')">   
                ...
                @empty
                    <td colspan="3">
                        <span class="text-danger">
                            <strong>No company_size Found!</strong>
                        </span>
                    </td>
                    @endforelse
                </table>
