                ...
                <table class="table nowrap" id="project-status">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span class="f-light f-w-600">state Name</span>
                            </th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-switch form-check-inline">
                                            ...
                                            onchange="handleStatus({{ $stateDetail->id }})" id="checked_value_{{ $stateDetail->id }}" class="form-check-input switch-info check-size">
