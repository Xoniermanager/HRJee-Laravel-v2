                    ...
                    <table class="table nowrap" id="project-status">
                      <thead>
                        ...
                        <tr >
                          ...
                          <td>
                            <a href="company_detail.html"> <p class="f-light">{{$companiesDetails->name}}</p></a>
