          ...
          <div class="card">
            <div class="card-header file-content border-0 pb-0">
              <div class="d-md-flex d-sm-block">
                ...
                <div class="flex-grow-1 text-end">
                  <a class="d-inline-flex" href="{{route('super_admin.add_company')}}" >
            ...
            <div class="card-body">
              <div class="list-product-header">
                ...
                <div class="collapse show" id="collapseProduct" style="">
                  <div class="card card-body list-product-body">
                    <div class="row  g-3">
                      ...
                      <div class="col">
                        <select class="form-select" aria-label="Default select example" name="filterByStatus" id="filterByStatus">
              ...
              @include('super_admin.company.company_list')
            </div>
          </div>
        </div>
      </div>
...
<script>
          function deleteFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?= route('super_admin.company.delete') ?>",
                        type: "get",
                        data: {
                            id: id
                        },
        ...
        {
            $.ajax({
                    url: "{{ route('super_admin.company.search') }}",
                    type: 'get',
                    data: {
                        'key': key,
                        'status': status,
        ...
        function handleStatus(id) {
            ...
            console.log(status);
            $.ajax({
                url: "{{ route('super_admin.company.statusUpdate') }}",
                type: 'get',
                data: {
                    'id': id,
                    'status': status,
