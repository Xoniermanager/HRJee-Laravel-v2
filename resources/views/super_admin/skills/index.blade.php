...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @include('super_admin.skills.skill_list')
    ...
    $(document).on("input", "#search", function(e) {
        ...
        {
            $.ajax({
                    url: "{{ route('super_admin.skill.search') }}",
                    type: 'get',
                    data: {
                        'key': key,
                        'status': status,
        ...
        jQuery(document).ready(function($) {
            jQuery("#skill_form").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('super_admin.skill.store') }}",
                        type: 'POST',
                        data: skill_data,
        ...
        function deleteFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?= route('super_admin.skill.delete') ?>",
                        type: "get",
                        data: {
                            id: id
                        },
        ...
        jQuery("#skill_update_form").validate({
            ...
            submitHandler: function(form) {
                var skill_data = $(form).serialize();
                $.ajax({
                    url: "<?= route('super_admin.skill.update') ?>",
                    type: 'post',
                    data: skill_data,
                    success: function(response) {
        ...
        function handleStatus(id) {
            ...
            console.log(status);
            $.ajax({
                url: "{{ route('super_admin.skill.statusUpdate') }}",
                type: 'get',
                data: {
                    'id': id,
                    'status': status,
