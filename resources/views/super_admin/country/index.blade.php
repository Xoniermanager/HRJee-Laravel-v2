...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @include('super_admin.country.country_list')
    ...
    $(document).on("input", "#search", function(e) {
        ...
        {
            $.ajax({
                    url: "{{ route('super_admin.country.search') }}",
                    type: 'get',
                    data: {
                        'key': key,
                        'status':status,
        ...
        jQuery(document).ready(function($) {
            jQuery("#country_form").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('super_admin.country.store') }}",
                        type: 'POST',
                        data: country_data,
        ...
        function deleteFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?= route('super_admin.country.delete') ?>",
                        type: "get",
                        data: {
                            id: id
                        },
        ...
        jQuery("#country_update_form").validate({
            ...
            submitHandler: function(form) {
                var country_data = $(form).serialize();
                $.ajax({
                    url: "<?= route('super_admin.country.update') ?>",
                    type: 'post',
                    data: country_data,
                    success: function(response) {
        ...
        function handleStatus(id) {
            ...
            console.log(status);
            $.ajax({
                url: "{{ route('super_admin.country.statusUpdate') }}",
                type: 'get',
                data: {
                    'id': id,
                    'status': status,
