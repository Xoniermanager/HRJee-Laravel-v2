...
<head>
    ...
    <link rel="icon" href="super_admin/assets/images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="super_admin/assets/images/favicon.png" type="image/x-icon">
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="super_admin/assets/css/font-awesome.css">
        ...
        <div class="row m-0">
          <div class="col-12 p-0">    
            <div class="login-card login-dark">
              <div>
                <div><a class="logo" href="index.html"><img class="img-fluid for-light" src="{{asset('super_admin/assets/images/logo.png')}}" alt="looginpage" width="120px">
                    <img class="img-fluid for-dark" src="{{asset('super_admin/assets/images/logo-light.png')}}" alt="looginpage"  width="120px"></a></div>
                <div class="login-main"> 
                  <form class="theme-form">
                    ...
                    <div class="form-group mb-0">
                      ...
                      </div><a class="link" href="forget_password.html">Forgot password?</a>
