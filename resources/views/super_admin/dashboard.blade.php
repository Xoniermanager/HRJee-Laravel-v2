                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      <ul class="notification-box">
                        <li class="d-flex"> 
                          <div class="flex-shrink-0 bg-light-primary"><img src="{{ asset('super_admin/assets/images/avatar.png')}}" alt="xonier" width="20px"></div>
                        ...
                        <li class="d-flex"> 
                          <div class="flex-shrink-0 bg-light-info"><img src="{{ asset('super_admin/assets/images/favicon.png')}}" alt="paywho" width="20px"></div>
                          <div class="flex-grow-1"> <a href="#">
                              <h5>Paywho</h5></a>
                            <p class="text-truncate">Subcription expire soon</p>
                        ...
                        <li class="d-flex"> 
                            <div class="flex-shrink-0 bg-light-warning"><img src="{{ asset('super_admin/assets/images/icon/profit.png')}}" alt="paywho" width="20px"></div>
                            <div class="flex-grow-1"> <a href="#">
                                <h5>Paywho</h5></a>
                        ...
                        <div class="row">
                            <div class="col-3 statistic-icon">
                                <div class="light-card balance-card widget-hover">
                                    <div class="icon-box"><img src="{{ asset('super_admin/assets/images/icon/customers.png')}}"
                                            alt=""></div>
                            ...
                            <div class="col-3 statistic-icon">
                                <div class="light-card balance-card widget-hover">
                                    <div class="icon-box"><img src="{{ asset('super_admin/assets/images/icon/revenue.png')}}" alt="">
                                    </div>
                            ...
                            <div class="col-3 statistic-icon">
                                <div class="light-card balance-card widget-hover">
                                    <div class="icon-box"><img src="{{ asset('super_admin/assets/images/icon/profit.png')}}" alt="">
                                    </div>
