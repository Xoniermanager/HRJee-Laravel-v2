						...
						<div class="w-450px">
							...
							<div class="card card-body zoom-out p-10">
								...
								<form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework overflow-hidden" id="kt_sign_in_form"
									data-kt-redirect-url="/metronic8/demo3/../demo3/index.html" action="{{ route('login') }}" method="POST">
									@csrf
									<!--begin::Input group=-->
									...
									<div class="fv-row fv-plugins-icon-container mb-3">
										...
										<label class="w-100">Password <a href="{{ route('forget.password') }}"
												...
												Password ?</a></label>
										<input type="password" name="password" autocomplete="off" class="form-control-signin animate-left"
											value="{{ old('password') }}">
										@error('password')
											<span class="text-red-500">{{ $message }}</span>
										@enderror
