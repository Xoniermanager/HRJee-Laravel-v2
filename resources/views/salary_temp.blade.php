...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <p><strong>Total In-Hand Salary in Words (Monthly): </strong> {{ numberToWords($employeeMonthlySalary['others']['monthly_earnings']) }}</p>
        </div>
        ...
        <div class="card">
            ...
            <p><strong>Total In-Hand Salary in Words (Yearly): </strong> {{ numberToWords($employeeCtcComponents['others']['yearly_earnings']) }}</p>
        </div>
    </div>
