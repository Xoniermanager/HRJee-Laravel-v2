<div class="content d-flex flex-column flex-column-fluid fade-in-image" id="kt_content">
    ...
    <div class="container-xxl" id="kt_content_container">
        ...
        <div class="row gy-5 g-xl-10">
            ...
            <div class="mb-5">
                <div class="card">
                    <div class="card-body w-100 border-0 rounded-0" id="kt_drawer_chat_messenger">
                        <!--begin::Card header-->
                        <div class="card-header pe-5 p-0 mb-3" id="kt_drawer_chat_messenger_header">
                            <!--begin::Title-->
                        ...
                        <div class="" id="kt_drawer_chat_messenger_body">
                            ...
                            <div class="chat-footer" id="kt_drawer_chat_messenger_footer">
                                <form class="row" id="message_form"
                                    action="{{ route('send.message', Request::segment(4)) }}" method="post">
                                    @csrf
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <button type="submit" class="btn btn-primary" disabled="disabled"
                                            id="send" data-kt-element="send">Send</button>
                                    </div>
                                </form>
                            </div>
                            <!--end::Messages-->
