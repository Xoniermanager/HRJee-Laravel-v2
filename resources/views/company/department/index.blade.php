				...
				<div class="card-header cursor-pointer p-0">
					...
					<div class="card-title m-0">
						<div class="d-flex align-items-center position-relative my-1">
							...
							<!--end::Svg Icon-->
							<input class="form-control form-control-solid min-w-150px me-2 ps-14" placeholder="Search " type="text"
						...
						<select name="status" class="form-control min-w-150px me-2" id="status">
							...
							<option {{ old('status') == '1' || request()->get('status') == '1' ? 'selected' : '' }} value="1">Active
							</option>
							<option {{ old('status') == '0' || request()->get('status') == '0' ? 'selected' : '' }} value="0">Inactive
							</option>
						</select>
