...
<div class="content d-flex flex-column flex-column-fluid fade-in-image" id="kt_content">
        ...
        <div class="row gy-5 g-xl-10">
            ...
            <div class="card card-body col-md-12">
                <div class="card-header cursor-pointer p-0">
                    ...
                    <!--end::Card title-->
                    <!--begin::Action-->
                    <a href="#" data-bs-toggle="modal" data-bs-target="#add_attendance_status"
                        class="btn btn-sm btn-primary align-self-center">
                        Add Attendance Status</a>

                    <!--end::Action-->
                </div>

                <div class="mb-5 mb-xl-10">
                    @include('company.attendance_status.attendance_status_list')
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
    ...
    <div class="modal" id="edit_attendance">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-500px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y pt-0 pb-5 border-top">
                    <!--begin::Wrapper-->
                    <form id="attendance_status_update_form">
                        @csrf
    ...
    <!----------modal------------>
    <div class="modal" id="add_attendance_status">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-500px">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <!--begin::Modal body-->
                <div class="modal-body scroll-y pt-0 pb-5 border-top">
                    <form id="attendance_status_create_form">
                        @csrf
                        <!--begin::Wrapper-->
                        <div class="mw-lg-600px mx-auto p-4">
                            <!--begin::Input group-->
    ...
    <script>
        function edit_attendance_status_details(id, name,required_hours) {
            ...
            jQuery('#edit_attendance').modal('show');
        }
        jQuery.noConflict();
        jQuery(document).ready(function($) {
            jQuery("#attendance_status_create_form").validate({
                rules: {
                    name: "required",
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('attendance.status.store') }}",
                        type: 'POST',
                        data: country_data,
                        success: function(response) {
                            jQuery('#add_attendance_status').modal('hide');
                            swal.fire("Done!", response.message, "success");
                            $('#attendance_status_list').replaceWith(response.data);
                            jQuery("#attendance_status_create_form")[0].reset();
        ...
        function handleStatus(id) {
            ...
            $.ajax({
                url: "{{ route('attendance.status.statusUpdate') }}",
                type: 'get',
                data: {
                    'id': id,
                    'status': status,
        ...
        function deleteFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?= route('attendance.status.delete') ?>",
                        type: "get",
                        data: {
                            id: id
                        },
                        success: function(res) {
                            ...
                            $('#attendance_status_list').replaceWith(res.data);
                        },
