                                ...
                                <div class="table-responsive">
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                            $checkbox = '';
                                            if ($item->name === 'Basic pay' || $item->name === 'Special allowance')
                                            $checkbox = 'readonly';
                                            @endphp
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="d-flex align-items-center gap-1">
                                                        <input type="hidden" name="componentDetails[{{ $item->id }}][id]" value="{{ $item->id }}">
                                                        {{ $item->name }}
                                                    </div>
                                                    @else
                                                    <div class="d-flex align-items-center gap-1">
                                                ...
                                                <td>
                                                    <div class="mt-2">
                                                        <input type="radio" name="componentDetails[{{ $item->id }}][earning_or_deduction]" value="earning" class="ml-2" {{ $item->earning_or_deduction == 'earning' ? 'checked' : '' }} {{ $checkbox }}>
                                                        <label class="ml-1">Earning</label>
                                                        <input type="radio" name="componentDetails[{{ $item->id }}][earning_or_deduction]" value="deduction" class="ml-2" {{ $item->earning_or_deduction == 'deduction' ? 'checked' : '' }} {{ $checkbox }}>
                                                        <label class="ml-1">Deduction</label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="mt-2">
                                                        <input type="radio" name="componentDetails[{{ $item->id }}][value_type]" value="fixed" class="ml-2" {{ $item->value_type == 'fixed' ? 'checked' : '' }} {{ $checkbox }}>
                                                        <label class="ml-1">Fixed</label>
                                                        <input type="radio" name="componentDetails[{{ $item->id }}][value_type]" value="percentage" class="ml-2" {{ $item->value_type == 'percentage' ? 'checked' : '' }} {{ $checkbox }}>
