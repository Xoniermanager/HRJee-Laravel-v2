            ...
            <form class="row" id="save-assign-anouncement-frm">
                        ...
                        <div class="row card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="bg-white form-select form-select-solid" data-control="select2"
                                    ...
                                    data-allow-clear="true" name="announcement_id" id="announcement_id"
                                    style="width:100%">
                                    <option value=""></option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" readonly   id='assign_description'>{{ $announcement->description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="h-100">
                        <div class="row card-body">
                            <div
                                class="form-group {{ !empty(auth()->guard('admin')->user()->company_id) && empty(auth()->guard('admin')->user()->branch_id) ? '' : 'd-none' }}">
                                ...
                                <select class="bg-white form-select form-select-solid" data-control="select2"
                                    ...
                                    @foreach ($branches as $key => $row)
                                        <option value="{{ $row->id }}"
                                            {{ $type != 3 && in_array($row->id, $branch_id) ? 'selected' : '' }}>
                                            {{ $row->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="bg-white form-select form-select-solid" data-control="select2"
                                    data-close-on-select="false" data-placeholder="Select the Company Branch"
                                    data-allow-clear="true" multiple name="designation_id[]" id="designation_id"
                                    style="width:100%">
                                    <option value=""></option>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        $('.employee_listing').html(html);
                        let departments = '<option value="all">all</option>';
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        $('.employee_listing').html(html);
                        let designations = '<option value="all">all<option>';
