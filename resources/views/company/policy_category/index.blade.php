...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid fade-in-image" id="kt_content">
            ...
            <div class="row gy-5 g-xl-10">
                ...
                <div class="card card-body col-md-12">
                    <div class="card-header cursor-pointer p-0">
                        ...
                        <!--end::Card title-->
                        <!--begin::Action-->
                        <a href="#" data-bs-toggle="modal" data-bs-target="#add_policy_category"
                            class="btn btn-sm btn-primary align-self-center">
                            Add Policy Category</a>

                        <!--end::Action-->
                    </div>

                    <div class="mb-5 mb-xl-10">
                        @include('company.policy_category.policy_category_list')
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Row-->
        ...
        <div class="modal" id="edit_policy_category">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-500px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y pt-0 pb-5 border-top">
                        <!--begin::Wrapper-->
                        <form id="policy_category_update_form">
                            @csrf
        ...
        <!----------modal------------>
        <div class="modal" id="add_policy_category">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-500px">
                <!--begin::Modal content-->
                <div class="modal-content">
        ...
        <script>
            function edit_policy_category_details(id, name) {
                $('#id').val(id);
                $('#name').val(name);
                jQuery('#edit_policy_category').modal('show');
            }
            jQuery.noConflict();
            jQuery(document).ready(function ($) {

                // Custom validation method for alpha and spaces only
                ...
                function applyValidation(formSelector, url, modalSelector) {
                        ...
                        submitHandler: function (form) {
                            ...
                            $.post(url, formData)
                                .done(function (response) {
                                    ...
                                    $('#policy_category_list').replaceWith(response.data);
                                    form.reset();
                                })
                ...
                // Apply validation to create and update forms
                applyValidation("#policy_category_form", "{{ route('policy.category.store') }}", '#add_policy_category');
                applyValidation("#policy_category_update_form", "<?= route('policy.category.update') ?>", '#edit_policy_category');
            ...
            function handleStatus(id) {
                ...
                $.ajax({
                    url: "{{ route('policy.category.statusUpdate') }}",
                    type: 'get',
                    data: {
                        'id': id,
                        'status': status,
            ...
            function deleteFunction(id) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?= route('policy.category.delete') ?>",
                            type: "get",
                            data: {
                                id: id
                            },
                            success: function (res) {
                                ...
                                $('#policy_category_list').replaceWith(res.data);
                            },
                            error: function (xhr, ajaxOptions, thrownError) {
                                Swal.fire("Cannot Delete", "This category is assigned to policies and cannot be deleted.", "error");
                            }
                        });
                    }
                });
