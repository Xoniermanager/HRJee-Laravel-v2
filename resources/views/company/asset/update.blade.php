        ...
        <div class="col-lg-12 col-xl-12 col-xxl-12 mb-5">
            ...
            <div class="card h-md-100">
                ...
                <div class="card-header p-0 align-items-center">
                    <div class="card-body">
                        <form action="{{ route('asset.update',$editAssetDetails->id) }}" method="post" id="asset_create_form" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4 form-group">
                                        <label for="">Name *</label>
                                        <input type="text" name="name" class="form-control" value="{{$editAssetDetails->name}}">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select name="asset_category_id" class="form-control">
                                            ...
                                            @foreach ($allAssetCategory as $assetCategory)
                                                <option {{$editAssetDetails->asset_category_id == $assetCategory->id ? 'selected' : ''}} value="{{ $assetCategory->id }}">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select class="form-control" name="asset_manufacturer_id">
                                            ...
                                            @foreach ($allAssetManufacturer as $assetManufacturer)
                                                <option {{$editAssetDetails->asset_manufacturer_id == $assetManufacturer->id ? 'selected' : ''}} value="{{ $assetManufacturer->id }}">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" name="model" id="" class="form-control" value="{{$editAssetDetails->model}}">
                                        @if ($errors->has('model'))
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" name="purchase_value" id="" class="form-control" value="{{$editAssetDetails->purchase_value}}">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" name="depreciation_per_year" id="" class="form-control" value="{{$editAssetDetails->depreciation_per_year}}">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" name="invoice_no" id="" class="form-control" value="{{$editAssetDetails->invoice_no}}">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="date" name="invoice_date" id="" class="form-control" value="{{$editAssetDetails->invoice_date}}">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="date" name="validation_upto" id="" class="form-control" value="{{$editAssetDetails->validation_upto}}">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" name="serial_no" id="" class="form-control" value="{{$editAssetDetails->serial_no}}">
                                    ...
                                    <div class="col-md-4 form-group mt-5 pt-1">
                                        <div class="toggle">
                                            <input type="radio" name="ownership" value="owned" id="sizeWeight"
                                                checked="checked" {{$editAssetDetails->ownership == 'owned' ? 'checked' : ''}} />
                                            <label for="sizeWeight">Owned</label>
                                            <input type="radio" name="ownership" value="rented" id="sizeDimensions" {{$editAssetDetails->ownership == 'rented' ? 'checked' : ''}}/>
