...
@section('content')
@section('title','Add Salary Component Assignment')
        ...
        <div class="col-lg-12 col-xl-12 col-xxl-12 mb-5">
            ...
            <div class="card h-md-100">
                ...
                <div class="card-header p-0 align-items-center">
                    <div class="card-body">
                        <form action="{{ route('salary.component_assign.store') }}" method="post">
                            @csrf
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select name="salary_id" id="" class="form-control">
                                            <option value="">Select The Salary</option>
                                            @foreach ($allSalaries as $item)
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label class="required">Salary Component</label>
                                        <select name="salary_component_id" id="salary_component_id" class="form-control" onchange="getComponentDetails(this)">
                                            <option value="">Select The Salary Component</option>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input class="form-control" type="text" name="value"
                                            value="{{ old('value') }}" pattern="^[0-9]*\.?[0-9]+$">
                                        @if ($errors->has('value'))
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="mt-2">
                                            <input type="radio" name="earning_or_deduction" value="earning" class="ml-1"
                                                {{ old('earning_or_deduction')=='earning' ? 'checked' : '' }}>
                                                <label class="ml-2">Earning</label>
                                            <input type="radio" name="earning_or_deduction" value="deduction"class="ml-1"
                                            {{ old('earning_or_deduction')=='deduction' ? 'checked' : '' }}><label class="ml-2">Deduction</label>
                                        </div>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="mt-2">
                                            <input type="radio" name="is_default" value="1" class="ml-2" {{
                                                old('is_default')=='1' ? 'checked' : '' }}>
                                            <label class="ml-1">Yes</label>
                                            <input type="radio" name="is_default" value="0" class="ml-2" {{
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select name="parent_component" id="" class="form-control">
                                            ...
                                            <option value="{{ $basicDetails->id }}" {{
                                                old('parent_component')==$basicDetails->id ? 'selected' : '' }}>{{
                                                $basicDetails->name }}</option>
                                        </select>
...
<script>
    ...
    {
        let data = $('#salary_component_id').attr("data-item");
        console.log($('#salary_component_id').attr('data-item'));
    }
</script>
@endsection
