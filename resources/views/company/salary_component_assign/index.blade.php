...
<div class="content d-flex flex-column flex-column-fluid fade-in-image" id="kt_content">
        ...
        <div class="row gy-5 g-xl-10">
            ...
            <div class="card card-body col-md-12">
                <div class="card-header cursor-pointer p-0">
                    ...
                    <!--end::Card title-->
                    <!--begin::Action-->
                    <a href="{{ route('salary.component_assign.add') }}" class="btn btn-sm btn-primary align-self-center">
                        Add Salary Component Assignment</a>
                    <!--end::Action-->
                </div>
                @if (session('error'))
                ...
                <div class="mb-5 mb-xl-10">
                    @include('company.salary_component_assign.list')
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
    ...
    <script>
        ...
        function searchFilter()
        {
            $.ajax({
                type: 'GET',
                url: company_ajax_base_url + '/salary-component-assignment/search/filter',
                data: {
                    'search': $('#search').val(),
