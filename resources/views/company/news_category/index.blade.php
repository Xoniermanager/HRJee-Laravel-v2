...
<div class="content d-flex flex-column flex-column-fluid fade-in-image" id="kt_content">
        ...
        <div class="row gy-5 g-xl-10">
            ...
            <div class="card custom-table p-0">
                <div class="card-header cursor-pointer">
                    ...
                    <!--end::Card title-->
                    <!--begin::Action-->
                    <a href="#" data-bs-toggle="modal" data-bs-target="#add_news_category"
                ...
                <div class="mb-5 mb-xl-10">
                    @include('company.news_category.news_category_list')
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
    ...
    <div class="modal" id="edit_news_category">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-500px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y pt-0 pb-5 border-top">
                    <!--begin::Wrapper-->
                    <form id="news_category_update_form">
                        @csrf
    ...
    <!----------modal------------>
    <div class="modal" id="add_news_category">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-500px">
            <!--begin::Modal content-->
            <div class="modal-content">
    ...
    <script>
        function edit_news_category_details(id, name) {
            $('#id').val(id);
            $('#name').val(name);
...
jQuery(document).ready(function($) {
    ...
    applyValidation("#news_category_update_form", "<?= route('news.category.update') ?>", '#edit_news_category');
        ...
        function handleStatus(id) {
            ...
            $.ajax({
                url: "{{ route('news.category.statusUpdate') }}",
                type: 'get',
                data: {
                    'id': id,
                    'status': status,
        ...
        function search_filter_results() {
            $.ajax({
                type: 'GET',
                url: company_ajax_base_url + '/news/news-category/search/filter',
                data: {
                    'status': $('#status').val(),
                    'search': $('#search').val()
                },
