        ...
        <div class="row gy-5 g-xl-10">
            ...
            <div class="card card-body col-md-12">
                <div class="card-header cursor-pointer p-0">
                    ...
                    <!--end::Card title-->
                    <!--begin::Action-->
                    <a href="{{ route('offer.add') }}" class="btn btn-sm btn-primary align-self-center">
                        Add Offer</a>
                    <!--end::Action-->
                </div>
                <div class="mb-5 mb-xl-10">
                    @include('company.offers.list')
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
    ...
    <script>
        $(document).ready(function() {
            ...
            function search_filter_results() {
                $.ajax({
                    type: 'GET',
                    url: company_ajax_base_url + '/offer/search/filter',
                    data: {
                        'status': $('#status').val(),
                        'search': $('#search').val()
                    },
                    success: function(response) {
                        $('#offer_list').replaceWith(response.data);
                    }
                });
            }
