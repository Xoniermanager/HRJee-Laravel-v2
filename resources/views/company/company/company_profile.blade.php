                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <a  class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{isset($companyDetails)?$companyDetails->name:'Admin'}}</a>
                            ...
                            <div class="d-flex my-4">
                                ...
                                <a href="#" class="btn btn-sm btn-primary ms-3 align-self-center wt-space" data-bs-toggle="modal" data-bs-target="#change_password">
                                    Change Password</a>
        ...
        <!--end::Modal dialog-->
                ...
                <ul class="nav nav-pills nav-pills-custom mb-3 mt-10" role="tablist">
                    ...
                    <li class="nav-item  me-3 me-lg-6" role="presentation">
                        <!--begin::Link-->
                        <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden  h-55px py-4 active" data-bs-toggle="pill" href="#kt_profile_details_view" aria-selected="false" role="tab" tabindex="-1">
        ...
        <div class="tab-content">
            <div class="card tab-pane fade active show  mb-5 mb-xl-10" id="kt_profile_details_view" role="tabpanel">
                ...
                <div class="card-body p-9">
                    <form method="post" action="{{route('update.company',['id' => $companyDetails->id])}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" name="name" type="text" value="{{isset($companyDetails)?$companyDetails->name:''}}"> 
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="">User Name </label>
                                <input class="form-control" name="username" type="text" value="{{isset($companyDetails)?$companyDetails->username:''}}"> 
                            </div>
                            
                            <div class="col-md-6 form-group">
                                <label for="">Company Email Id </label>
                                <input class="form-control" name="email" type="email" value="{{isset($companyDetails)?$companyDetails->email:''}}"> 
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="">Contact Number </label>
                                <input class="form-control" name="contact_no" type="number" value="{{isset($companyDetails)?$companyDetails->contact_no:''}}"> 
                            </div>
                    ...
                    <form method="post" action="{{route('update.branch',['id' => $companyBranch->id])}}">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" name="name" type="text" value="{{isset($companyBranch)?$companyBranch->name:''}}"> 
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                <label for="">Contact Number</label>
                                <input class="form-control" name="contact_no" type="text" value="{{isset($companyBranch)?$companyBranch->contact_no:''}}"> 
                            </div>

                            <div class="col-md-6 form-group">
                                <label for="">Email</label>
                                <input class="form-control" name="email" type="text" value="{{isset($companyBranch)?$companyBranch->email:''}}"> 
                            </div>

                            <div class="col-md-6 form-group">
                                <label for="">HR Email</label>
                                <input class="form-control" name="hr_email" type="text" value="{{isset($companyBranch)?$companyBranch->hr_email:''}}"> 
                            </div>


                            <div class="col-md-6 form-group">
                                <label for="">Company Address *</label>
                                <input class="form-control" name="address" type="text" value="{{isset($companyBranch)?$companyBranch->address:''}}"> 
                            </div>
                            
                            <div class="col-md-6 form-group">
                                <label for="">State *</label>
                                {{-- <input class="form-control" name="" type="text" value="@stateName($companyBranch->state)">  --}}
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" name="pincode" type="text" value="{{isset($companyBranch)?$companyBranch->pincode:''}}"> 
                            </div>
