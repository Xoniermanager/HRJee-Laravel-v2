<div class="tab-pane fade" id="bank_details_tab">
    ...
    <button onclick="show_next_tab('address_tab')" class="tab-btn-inline btn btn-primary"><i class="fa fa-arrow-left"></i>
        Previous</button>
    <button onclick="show_next_tab('qualification_tab')" class="tab-btn-inline btnnext btn btn-primary float-right">Next <i
