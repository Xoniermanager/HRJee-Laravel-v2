        ...
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <select class="form-control" name="allow_face_nex" id="allow_face_nex">
                    ...
                    <option {{ isset($singleUserDetails) && $singleUserDetails->details->allow_face_nex=='0' ? 'selected' : '' }} value="0">No
                    </option>
                    <option {{ isset($singleUserDetails) && $singleUserDetails->details->allow_face_nex=='1' ? 'selected' : '' }} value="1">Yes
                    </option>
                </select>
            </div>
            @endif
