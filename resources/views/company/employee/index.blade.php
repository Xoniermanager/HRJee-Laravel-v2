                        ...
                        <form class="row" id="filter_id">
                            <div class="col-md-2 mb-1" id="gender_div">
                                <select class="form-control filter_form" name="gender" id="gender">
                                    ...
                                    <option value="M" {{ request()->get('gender') == 'M' || old('gender') == 'M' ? 'selected' : '' }}>
                                        Male
                                    </option>
                                    <option value="F" {{ request()->get('gender') == 'F' || old('gender') == 'F' ?'selected' : '' }}>
                                        Female</option>
                                    <option value="O" {{ request()->get('gender') == 'O' || old('gender') == 'O' ? 'selected' : '' }}>
                                        Other</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-2 mb-1">
                                <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#filter_popup">More Filter</a>
                            </div>
                        </form>
