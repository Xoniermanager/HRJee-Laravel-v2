                        ...
                        <form action="{{ route('export.employee') }}" method="post" id="export_employee_form">
                            ...
                            <div class="row w-100">
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input me-3 filter" type="checkbox" checked name="name">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input me-3 filter" type="checkbox" name="joining_date"
                                            checked>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input me-3 filter" type="checkbox" name="date_of_birth"
                                            checked>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input me-3 filter" type="checkbox" name="blood_group"
                                            checked>
                ...
                <div class="modal-body scroll-y p-4">
                    <form action="{{ route('export.employee.address.details') }}" method="post"
                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input me-3 filter" type="checkbox" name="permanent_country"
                                        checked>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input me-3 filter" type="checkbox" name="permanent_state"
                                        checked>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input me-3 filter" type="checkbox" name="permanent_address"
                                        checked>
