...
var KTChartsWidget18 = function () {
    ...
    var initChart = function(chart) {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['1 Nov', '2 Nov', '3 Nov', '4 Nov', '5 Nov', '6 Nov', '7 Nov'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
            ...
            colors: [KTUtil.getCssVariableValue('--kt-danger'), KTUtil.getCssVariableValue('--kt-primary-light')],
            grid: {
                borderColor: borderColor,
                strokeDashArray: 4,
                yaxis: {
...
var KTChartsWidget20 = function () {
    ...
    var initChart = function(chart) {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['', 'Oct 02', 'Oct 03', 'Oct 04', 'Oct 05', 'Oct 06', 'Oct 07', 'Oct 08', 'Oct 09', 'Oct 10', 'Oct 11', 'Oct 12', 'Oct 13', 'Oct 14', 'Oct 17', 'Oct 18', 'Oct 19', 'Oct 21', ''],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
