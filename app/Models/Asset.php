...
class Asset extends Model
{
    ...
    protected $fillable = ['name', 'company_id', 'asset_category_id', 'asset_manufacturer_id', 'asset_status_id', 'model', 'ownership', 'purchase_value', 'depreciation_per_year', 'invoice_no', 'invoice_date', 'serial_no', 'invoice_file', 'allocation_status', 'validation_upto', 'created_by'];
